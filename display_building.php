...
<input type="text" class="form-control form-controlf input-width" name="condition" id="" placeholder="Search">
  ...
  <tr> 
    ...
    <a class="btn btnf btn-primary btn-center1"href="/open-ended/add_building.php">Add record</a>
