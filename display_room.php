...
$select = " SELECT * FROM room WHERE $attribute='$condition'" ;
...
<input type="text" class="form-control input-width " name="condition" id="" placeholder="Search">
  ...
  <tr> 
		<th colspan="5"><h2>Hostel Room Database</h2></th> 
		</tr> 
		...
		{ 
		?> 
		<tr> <td><?php echo $rows['Room_Number']; ?></td> 
		<td><?php echo $rows['Capacity']; ?></td> 
		<td><?php echo $rows['Floor_Number']; ?></td> 
    ...
    <a class="btn btn-primary btn-center1"href="/open-ended/add_room.php">Add record</a>
